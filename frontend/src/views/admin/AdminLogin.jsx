...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push('/panelgsnadminbackend');
    } catch (error) {
    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="w-full max-w-md" data-testid="admin-login-page">
        <div className="text-center mb-8">
          <Link href="/"><img src={LOGO_URL} alt="GameShop Nepal" className="h-16 mx-auto" /></Link>
        ...
        <div className="mt-6 text-center"><Link href="/" className="text-white/40 hover:text-white text-sm">← Back to Site</Link></div>
      </div>
    </div>
  );
}
