...
const emptyProduct = { name: '', slug: '', description: '', image_url: '', category_id: '', variations: [], tags: [], custom_fields: [], sort_order: 0, is_active: true, is_sold_out: false, stock_quantity: null, flash_sale_end: '', flash_sale_label: '', whatsapp_only: false, whatsapp_message: '', discord_webhooks: [], is_giftcard: false };
              ...
              <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-4 space-y-4">
                ...
                <div className="flex items-start gap-3 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                  <Switch
                    ...
                    onCheckedChange={(checked) => setFormData({ ...formData, is_giftcard: checked })}
                  />
                  <div>
                    <label className="text-yellow-400 font-medium text-sm">Is a Gift Card?</label>
                    <p className="text-white/40 text-xs mt-0.5">When completing this order, admin enters the gift card code which is emailed to the customer</p>
                  </div>
                </div>
