        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              {posts.map((post) => (
                <Link key={post.id} href={`/blog/${post.slug}`} className="block bg-card border border-white/10 rounded-lg p-5 hover:border-gold-500/50 transition-all duration-300 group">
