...
import { productsAPI, ordersAPI, promoCodesAPI, settingsAPI, creditsAPI } from '@/lib/api';
...
export default function ProductPage({ initialProduct = null, productSlug: propSlug = null }) {
  const routeParams = useParams();
  const productSlug = propSlug || routeParams?.productSlug;
...
See invoice: ${invoiceUrl}`;
      ...
      // CLIENT-SIDE PRICE VALIDATION (security layer)
      // Only block obvious Rs 0 manipulation — let backend handle the rest
      if (orderData.total_amount <= 0 && currentVariation.price > 0) {
        toast.error('Order total mismatch. Please refresh and try again.');
      ...
      <div className="min-h-screen bg-black">
        ...
        <div className="pt-14 md:pt-24 pb-20 md:pb-8 min-h-[60vh] flex items-center justify-center px-4">
          <div className="text-center">
            ...
            <Link href="/"><Button variant="outline" className="border-gold-500 text-gold-500">Go Back Home</Button></Link>
          </div>
        </div>
        <Footer />
      </div>
    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="pt-14 md:pt-24 pb-20 md:pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 lg:py-4">
          <Link href="/" className="inline-flex items-center text-white/60 hover:text-gold-500 transition-colors text-sm" data-testid="back-to-home">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-6 lg:pb-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-10">
            <div className="lg:sticky lg:top-24 lg:self-start space-y-4" data-testid="product-image-container">
              ...
              {/* Sidebar Ad */}
              <AdBanner position="product_sidebar" className="block rounded-lg w-full max-w-[300px] mx-auto lg:max-w-none" />
            </div>
            ...
            <div className="space-y-4 lg:space-y-6 animate-slide-up" data-testid="product-details">
              ...
              <div className="space-y-3">
                ...
                <p className="text-white/40 text-xs text-center">By ordering, you agree to our <Link href="/terms" className="text-gold-500 hover:underline">Terms & Conditions</Link></p>
              </div>
              ...
              <div className="bg-white/[0.03] border border-white/10 rounded-xl p-4 space-y-3">
                <h3 className="text-sm font-semibold text-white uppercase tracking-wider">Why Buy From Us?</h3>
                <div className="grid grid-cols-2 gap-2">
                  <div className="flex items-center gap-2">
                    <span className="text-green-400 text-sm">✓</span>
                    <span className="text-white/60 text-xs">WhatsApp Delivery</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-green-400 text-sm">✓</span>
                    <span className="text-white/60 text-xs">4.7/5 Customer Rating</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-green-400 text-sm">✓</span>
                    <span className="text-white/60 text-xs">eSewa & Khalti Accepted</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-green-400 text-sm">✓</span>
                    <span className="text-white/60 text-xs">Trusted Since 2021</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-green-400 text-sm">✓</span>
                    <span className="text-white/60 text-xs">100% Genuine Products</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-green-400 text-sm">✓</span>
                    <span className="text-white/60 text-xs">1,500+ Happy Customers</span>
                  </div>
                </div>
              </div>
