...
export default function CustomerAccountPage() {
  ...
  const handleComplaintSubmit = async () => {
    ...
    if (!complaintForm.reason.trim() || complaintForm.reason.trim().length < 20) {
            ...
            {complaintSuccess ? (
              <div className="text-center py-6 space-y-4">
                ...
                <p className="text-white/50 text-sm leading-relaxed">
                  Your complaint has been raised. Please note that your issue with the order might take up to a week to be resolved. If it takes longer, you will be compensated with extended subscription or other rewards. You will receive an email update when your complaint is resolved or dismissed.
                </p>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/30 text-xs mt-1">
                      {complaintForm.reason.trim().length}/20 characters minimum
                    </p>
                  </div>
                  <Button
